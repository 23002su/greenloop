...
function EnergyMarket() {
  // states for walletId, amounts, prices, messages etc.
  // reuse your existing handlers and submitBid, submitAsk, fetchMessages, etc.
  ...
  // submitAsk, submitBid, fetchMessages, and decodeMessage come from your existing code

  return (
    <div className="energy-transaction">
      <WalletIdInput walletId={walletId} setWalletId={setWalletId} />
      <SellEnergy
        askAmount={askAmount}
        setAskAmount={setAskAmount}
        askPrice={askPrice}
      ...
      />
      {/* Uncomment if buying is a feature */}
      {/* <BuyEnergy
        bidAmount={bidAmount}
        setBidAmount={setBidAmount}
        bidPrice={bidPrice}
        setBidPrice={setBidPrice}
        submitBid={(e) => {/* submitBid(e) */}
      }{/*} />*/}
      <MessagesList
        messages={messages}
        loading={false}
